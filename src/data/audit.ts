...
export const auditTrail: AuditTrail = {
  ...
  steps: [
    ...
    { ts: '20:41:08.021', label: 'Routing evaluated', detail: '8 processors scored for Chase Visa-debit', decision: 'Helix selected · 91% expected value (cost-adjusted)', tone: 'info' },
    ...
    { ts: '20:41:08.075', label: 'Rerouted · Helix', detail: 'Approved · auth code 4471X', decision: 'Smart-retry success in 41ms · no customer impact', tone: 'positive' },
